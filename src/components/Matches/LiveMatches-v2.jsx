...
function LiveMatches({ onMatchClick }) {
  ...
  return (
    <div className="my-6 bg-blue-100 rounded-[2rem] pb-4">
      <h2 className="text-5xl text-blue-500 font-bold py-6 ml-4">
      ...
      {leagueIds.map((leagueId, index) => {
        ...
        return (
          <div
            key={leagueId}
            className={`text-3xl p-4 mb-4 ${
              index < leagueIds.length - 1 ? "border-b-2 border-blue-400" : ""
            }`}
          >
            ...
            {league.matches.map((match) => (
              <div
                ...
                className="mt-4 flex py-4 cursor-pointer hover:bg-purple-200 hover:rounded-xl"
