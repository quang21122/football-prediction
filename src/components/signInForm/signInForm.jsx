...
function UserInput({label, field, placeHolder}){
    return (
        <div className="flex flex-col text-xl w-[28rem]">
            <label className="font-semibold text-gray-700 mb-3">{label}</label>
            <input className ="h-16 bg-gray-100 p-2 rounded-md outline-none mb-8"
            type={field}
...
const SignInForm = () => 
{
    ...
    return (
            <div className="flex flex-col min-w-[360px] w-1/4 h-[42rem] items-center bg-white rounded-3xl">
                ...
                <div className="text-4xl text-red-400 font-bold mb-10">Football Prediction</div>
                ...
                className=" w-[28rem] h-16 bg-red-400 hover:bg-red-500 text-3xl text-white font-bold rounded-md outline-none mt-6">Đăng nhập</button>
                <div className="min-w-[300px] text-red-500 text-center text-2xl mt-8" >Chưa có tài khoản?  
...
const SignUpForm = () =>
{
    ...
    return(
        <div className="flex flex-col w-1/4 min-w-[300px] h-[50rem] items-center bg-white rounded-3xl">
            ...
            <button onClick={handleNavigateHome}
            className="w-[28rem] h-16 bg-red-400 hover:bg-red-500 text-3xl text-white font-bold rounded-md outline-none my-6 mb-12 ">Đăng ký</button>
            <div className="min-w-[300px] text-center text-red-500 mb-6 text-2xl" >Đã có tài khoản?  
